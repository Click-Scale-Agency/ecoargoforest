  ...
  return (
    <div className="font-['Plus_Jakarta_Sans',sans-serif]">
      <style>{`
        ...
        .testimonial-card:hover { transform: translateY(-4px); box-shadow: 0 0 0 2px rgba(61,122,61,0.28), 0 20px 40px rgba(61,122,61,0.09); }
      `}</style>
      ...
      <section className="min-h-screen flex flex-col font-body" style={{ background: 'linear-gradient(135deg, #0238F4 0%, #7A1DF2 45%, #00D6C9 100%)' }}>
        ...
        <div className="flex-1 flex flex-col items-center justify-center text-center px-6 py-16">
          <div className="flex flex-row items-center justify-center gap-8 mb-8">
            <div className="flex items-center gap-3">
              <img src={EAF.logo} alt="EcoAgroForest Logo" className="object-contain drop-shadow-lg" style={{ width: '160px', height: '160px' }} />
            </div>
          ...
          <div className="relative rounded-2xl overflow-hidden border-2 border-highlight shadow-2xl">
            <div className="pointer-events-none select-none">
              <div className="bg-highlight px-5 py-4 flex items-center justify-between">
                <div>
                  <p className="text-highlight-foreground font-bold text-sm">Digitālās klātbūtnes audits — EcoAgroForest SIA</p>
